          ...
          <div class="content__dough">
            ...
            <div class="sheet">
              ...
              <div class="sheet__content dough">
                <label class="dough__input dough__input--light" v-for="item in dough" :key="item.id">
          ...
          <div class="content__diameter">
            <div class="sheet">
              ...
              <div class="sheet__content diameter">
                <label class="diameter__input diameter__input--small" v-for="item in sizes" :key="item.id">
            ...
            <div class="sheet">
              ...
              <div class="sheet__content ingredients">
                ...
                <div class="ingredients__sauce">
                  ...
                  <label class="radio ingredients__input" v-for="item in sauces" :key="item.id">
                ...
                <div class="ingredients__filling">
                  ...
                  <ul class="ingredients__list">
                    <li class="ingredients__item" v-for="item in ingredients" :key="item.id">
                      <span class="filling filling--mushrooms">{{ item.name }}</span>
